...
Original file is located at
    https://colab.research.google.com/drive/1UJXxwYQU3iDDMHxP3Pk_g75sh6XXxpHl
"""
...
ts_df = deli.groupby(['match_id','inning']).sum()['total_runs'].reset_index()

ts_df

ts_df = ts_df[ts_df['inning'] == 1]

ts_df

match_df = matches.merge(ts_df[['match_id','total_runs']],left_on = 'id' , right_on = 'match_id')
...
"""final_df = final_df[final_df.sample(final_df.shape[0])]"""
...
temp_df,target = match_progression(deli_df,65,pipe)
temp_df
